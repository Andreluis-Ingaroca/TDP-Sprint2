...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String _email = "";
  String _password = "";
  String _passwordConfirm = "pwnotset";
  ...
  void _registerCommand() {
    ...
    rest.RestProvider().callMethod("/uc/su", params).then((value) {
      Navigator.pop(context);
    });
  }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Ingresa tus datos',
                        style: TextStyle(
                            fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.ingresarDatosColor),
                      ),
                      ...
                      TextFormField(
                        ...
                        validator: (val) {
                          return !EmailValidator.validate(val!.trim(), true)
