...
import 'package:lexp/widgets/task_group.dart';
                        ...
                        child: FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              CachedNetworkImageProvider chargedImage =
                              CachedNetworkImageProvider(gravatar.imageUrl());
                              return ListTile(
                                  onTap: () => {
                                  ...
                                  subtitle: Text(
                                    shared_service.SharedService().getIGN(
                                        snapshot.data!.username,
                    ...
                    ListTile(
                      title: Text('Configuraciones',
                          style: TextStyle(
                            ...
                            fontSize: 16,
                            color: AppColors.configuracionesColor,
                          )),
                      onTap: () {
                        // TODO: last page
                        Navigator.pop(context);
                    ...
                    ListTile(
                      title: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 16,
                          color: AppColors.notificacionesColor,
                        ),
                      ),
                      trailing: CircleGradientText(
                        inCircleText: "7",
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              backgroundColor: AppColors.dialogColor,
                                title: Text("Cerrar sesión", style: TextStyle(color: AppColors.dialogCerrarColor)),
                                content: Text(
                                    "¿Estás seguro de que quieres cerrar sesión?", style: TextStyle(color: AppColors.dialogContentColor)),
                                actions: <Widget>[
                                  TextButton(
                                    child: Text("Cancelar", style: TextStyle(color: AppColors.buttomCancelarColor)),
                                    onPressed: () {
      ...
      appBar: AppBar(
        title: Text(
          ...
          style: Theme.of(context)
              .textTheme.apply(bodyColor: AppColors.fechaColor, displayColor: AppColors.fechaColor)
              .bodySmall!
      ...
      children: [
        ...
        IconButton(
            ...
            icon: Icon(Icons.add_circle_outline,
                color: AppColors.addCircleColor))
      ],
    );
  }
      ...
      children: [
        ...
        StaggeredGridTile.count(
          ...
          child: TaskGroupContainer(
            ...
            icon: Icons.zoom_in,
            taskCount: 5,
            taskGroup: "Explorar", //sugerencias primero
          ),
        ),
        StaggeredGridTile.count(
          crossAxisCellCount: 1,
          ...
          child: TaskGroupContainer(
            ...
            icon: Icons.article,
            taskCount: 2,
            taskGroup: "Bloc de notas", //TODO: ver pagina 7 del PDF //ref
          ),
        ),
        StaggeredGridTile.count(
          crossAxisCellCount: 1,
